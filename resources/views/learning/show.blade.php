    ...
    <div class="grid gap-6 lg:grid-cols-[320px,1fr]">
        ...
        <aside class="rounded-lg bg-white border border-gray-200 overflow-hidden self-start">
            <div class="p-5 border-b border-gray-200">
                ...
                @if ($isCompleted)
                    <a href="{{ route('certificate.generate', $product->id) }}" class="mt-4 flex items-center justify-center gap-2 rounded-md bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700">
